    ...
    <>
      <section className="w-11/12 md:w-10/12 mx-auto">
        ...
        <div className="">
          ...
          <div className=" bg2 shadow-xl p-3 md:p-10 mb-20 min-h-[100px]">
            <div>
          ...
          {/* ==========form div for review===========  */}
          <div className="min-h-[200px]  p-3 md:p-10 bg2 border md:w-2/3 lg:w-2/5 mx-auto shadow-xl shadow-gray-400 mb-28">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              {user ? (
                ...
                <Link
                  onClick={() => Swal.fire("You Have to Login as a Tourist!")}
                  to="/login"
                  className="section-btn mt-2 w-60 text-center"
                >
                  add review
                </Link>
              )}
