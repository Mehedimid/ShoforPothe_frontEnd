      ...
      <div className="my-16 md:flex flex-row-reverse items-center gap-5 w-11/12 mx-auto">
        ...
        <Title heading={"Bangladesh's Best Travel Guide Since 2019"} subHeading={"About Shofor Pothe"} description={" "}></Title>
          ...
          <p className="text-start mt-5">
            ...
            believe in the power of exploration and the magic of discovery. Our
            mission is to connect travelers with the heart and soul of
            Bangladesh, providing not just a travel experience, but a
            transformative journey. Whether you're captivated by the bustling
            energy of Dhaka, enchanted by the serene landscapes of Sylhet, or
            intrigued by the ancient history of Mahasthangarh, we are here to
            guide you to the hidden gems and authentic moments that make
            Bangladesh a truly special destination.
          </p>
        </div>
      </div>

      {/* <SectionTitle>MEET OUT TEAM</SectionTitle> */}
        ...
        <section className="py-6 dark:bg-gray-800 dark:text-gray-100">
          <div className=" flex flex-col items-center justify-center p-4 mx-auto sm:p-10">
            ...
            <div className="flex flex-row  flex-wrap-reverse justify-center mt-8">
              <div className="flex flex-col  justify-center w-full px-8 mx-6 bg2 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 dark:bg-gray-100 dark:text-gray-800">
                <img
                  alt=""
              ...
              <div className="flex flex-col justify-center w-full px-8 mx-6 bg2 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 dark:bg-gray-100 dark:text-gray-800">
                ...
                />
                <div className="flex-1 my-4">
                  <p className="text-xl font-semibold leadi">jACK</p>
                  <p>DEVELOPER</p>
                </div>
                <div className="flex items-center justify-center p-3 space-x-3 border-t-2">
                  <a
              ...
              <div className="flex flex-col justify-center w-full px-8 mx-6 bg2 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 dark:bg-gray-100 dark:text-gray-800">
                ...
                />
                <div className="flex-1 my-4">
                  <p className="text-xl font-semibold leadi">NUHA</p>
                  <p>SOICAL STRATEGIST</p>
                </div>
                <div className="flex items-center justify-center p-3 space-x-3 border-t-2">
                  <a
                    rel="noopener noreferrer"
              ...
              <div className="flex flex-col justify-center w-full px-8 mx-6 bg2 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 dark:bg-gray-100 dark:text-gray-800">
                ...
                />
                <div className="flex-1 my-4">
                  <p className="text-xl font-semibold leadi">Asif Uddin</p>
                  <p>Admin</p>
                </div>
                <div className="flex items-center justify-center p-3 space-x-3 border-t-2">
                  <a
